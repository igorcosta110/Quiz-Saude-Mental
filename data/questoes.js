export const questoes = [
    {
        id: 1,
        pergunta: "O que é a ansiedade?",
        alternativas: [
            "Uma falha de caráter ligada à falta de controle emocional",
            "Um sintoma exclusivo da vida moderna e do uso excessivo de telas",
            "Um mecanismo natural do organismo focado na proteção e no alerta diante de ameaças",
    ...
    {
        id: 2,
        pergunta: "Qual é a diferença entre tristeza e depressão?",
        alternativas: [
            "A tristeza é uma emoção comum, mas a depressão é só a falta de Deus ou de serviço.",
            "A tristeza é passageira e motivada por fatos específicos, enquanto a depressão envolve a persistência dos sintomas por semanas e perda de interesse geral.",
            "Não existe diferença, a tristeza e a depressão são a mesma coisa e as duas são ruins",
    ...
    {
        id: 3,
        pergunta: "Como a prática de atividades físicas ajuda na saúde mental?",
        alternativas: [
            "Libera substâncias no cérebro que ajudam a melhorar o humor e a diminuir a ansiedade.",
            "Elimina o estresse para sempre, fazendo com a pessoa não se sinta mais triste.",
            "Substitui totalmente a necessidade de ter uma boa noite de sono.",
    ...
    },  
    {
        ...
        alternativas: [
            ...
            "Cura automaticamente qualquer tipo de ansiedade ou transtorno emocional.",
    ...
    {
        id: 5,
        pergunta: "Qual é a definição de Síndrome de Burnout?",
        alternativas: [
            "Um transtorno de ansiedade genético e sem relação com fatores externos.",
            "Um estado de cansaço momentâneo resolvido com um final de semana de descanso.",
            "Um fenômeno ocupacional causado pelo estresse crônico no ambiente de trabalho.",
    ...
    {
        id: 6,
        pergunta: "Qual é o efeito que o uso prolongado de redes sociais causa no nosso cérebro?",
        alternativas: [
            "Induz o cérebro a um estado de relaxamento similar à meditação.",
            "Suprime a produção de adrenalina, deixando o corpo em estado de letargia física.",
            "Aumenta a capacidade de foco e atenção sustentada em tarefas complexas.",
    ...
    {
        id: 7,
        pergunta: "Qual é a função de um psicólogo?",
        alternativas: [
            "Dar conselhos e tomar decisões pelo paciente sobre o que ele deve fazer na sua vida.",
            "Resolver conflitos emocionais complexos de forma imediata nas primeiras sessões.",
            "Tratar apenas casos graves de gente louca.",
    ...
    {
        id: 8,
        pergunta: "Segundo um famoso estudo de Harvard, qual é o principal fator relacionado a saúde mental e felicidade ao longo da vida?",
        alternativas: [
            "A qualidade das conexões sociais e relacionamentos.",
            "Alimentação saudável e prática de exercícios físicos.",
            "Somente a genética e nada mais.",
